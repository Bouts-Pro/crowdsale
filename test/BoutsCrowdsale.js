...
contract('BoutsCrowdsale', function ([_, wallet, remainingsWallet, boutsProWallet, wallet2, remainingsWallet2]) {
    ...
    function makeSuite(name, tests) {
        describe(name, async function () {
            beforeEach(async function () {
                ...
                crowdsale = await Crowdsale.new(startTime, endTime, rate, wallet, remainingsWallet, boutsProWallet);
